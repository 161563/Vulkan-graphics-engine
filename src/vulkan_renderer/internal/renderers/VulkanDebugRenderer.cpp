#include "vulkan_renderer/internal/renderers/VulkanDebugRenderer.hpp"
#ifdef USING_VULKAN
...
namespace Common {
	...
	Common::VulkanDebugRenderer::VulkanDebugRenderer(VulkanRenderer * renderer, VulkanLogicalDevice * device, VulkanDescriptorPool * descriptorPool)
	{
