#pragma once
#include <imgui.h>
#include "internal/utility/VulkanInstance.hpp"
#include "internal/utility/VulkanPhysicalDevice.hpp"
#include "internal/utility/VulkanLogicalDevice.hpp"
#include "internal/utility/VulkanDescriptorPool.hpp"
#include "internal/utility/VulkanPipeline.hpp"

#include "internal/renderers/VulkanSpriteRenderer.hpp"
#include "internal/renderers/VulkanDebugRenderer.hpp"
#include "internal/renderers/VulkanStaticMeshRenderer.hpp"
#include "internal/renderers/VulkanSkeletalMeshRenderer.hpp"
#include "internal/renderers/VulkanInstancedSkeletalMeshRenderer.hpp"

#include "internal/utility/vk_mem_alloc.h"
...
namespace Common
{
	...
	private:
		...
		// Allow use of std::make_shared
		friend class std::_Ref_count_obj<VulkanRenderer>;
	...
	public:
		...
		void StartSecondaryCommandBufferRecording(VkCommandBuffer buffer, VkCommandBufferUsageFlags flags, VkRenderPass renderPass, uint32_t subPass, VkFramebuffer framebuffer);
		...
		void EndSecondaryCommandBufferRecording(VkCommandBuffer buffer);
...
#pragma region CommandBuffers
		...
		std::vector<std::vector<VkCommandBuffer>> instancedSkeletalMeshShadowCommandBuffers_;
		...
		std::vector<VkCommandBuffer> instancedSkeletalMeshCommandBuffers_;
...
#pragma region Renderers
		...
		std::unique_ptr<VulkanInstancedSkeletalMeshRenderer> vulkanInstancedSkeletalMeshRenderer;

		bool renderInstancedSkeletons;
